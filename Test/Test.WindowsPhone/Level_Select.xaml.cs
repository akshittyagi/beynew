...
namespace Test
{
    ...
    public sealed partial class Level_Select : Page
    {
        ...
        public Level_Select()
        {
            ...
            //this.Siz
            dimx = Window.Current.Bounds.Width;
            dimy = Window.Current.Bounds.Height;

            back.Margin = new Thickness(dimx / 30, dimy / 12, 0, 0);
            flipView.Margin = new Thickness(dimx / 3.8, dimy / 3, 0, 0);
            flipView.Width = dimx * 0.5;
            flipView.Height = dimy * 0.4;
            proceed.Margin = new Thickness(dimx / 2.9, dimy / 1.4, 0, 0);
